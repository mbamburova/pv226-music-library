namespace DAL.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Album_ID = c.Int(nullable: false),
                        OriginalSong_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Albums", t => t.Album_ID, cascadeDelete: true)
                .ForeignKey("dbo.Songs", t => t.OriginalSong_ID)
                .Index(t => t.Album_ID)
                .Index(t => t.OriginalSong_ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Songs", "OriginalSong_ID", "dbo.Songs");
            ...
            DropIndex("dbo.Songs", new[] { "OriginalSong_ID" });

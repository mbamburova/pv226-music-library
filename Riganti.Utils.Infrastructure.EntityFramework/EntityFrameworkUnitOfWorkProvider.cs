...
namespace Riganti.Utils.Infrastructure.EntityFramework
{
    ...
    public class EntityFrameworkUnitOfWorkProvider : UnitOfWorkProviderBase
    {
        ...
        /// </summary>
        protected EntityFrameworkUnitOfWorkProvider(IUnitOfWorkRegistry registry, Func<DbContext> dbContextFactory)
            : base(registry)
        {
        ...
        ///     Creates the unit of work.
        /// </summary>
        protected virtual EntityFrameworkUnitOfWork CreateUnitOfWork(Func<DbContext> dbContextFactory,
